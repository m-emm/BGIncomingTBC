...
function BattleGroundModel.new()
    ...
    for bgKey, bg_desc in pairs(self.bf_desc) do
        ...
        for locationIndex = 1, #bg_desc.locations do
            ...
            local chatText =
                local_location_key_to_chat_text[currentLocationDesc.locationKey] or currentLocationDesc.locationKey
            local currentLocation = {
                locationKey = currentLocationDesc.locationKey,
                index = locationIndex,
                bgKey = bgKey,
                chatText = chatText
            }
...
function BattleGroundModel:locations()
    ...
    if bg_desc ~= nil then
        ...
        for i = 1, #bg_desc.locations do
            ...
            retval[currentLocation.locationKey] = {
